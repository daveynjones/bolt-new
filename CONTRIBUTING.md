...
deployed using Vite and Express.
...
- `pnpm run preview`: Builds the project and then starts it locally, useful for testing the production build. Note: HTTP streaming is supported in preview mode.
